...
export default function LoginPage() {
  ...
  return (
    // Full viewport, no scroll on this page
    <div className="relative h-[100svh] overflow-hidden flex items-center justify-center">
      <CosmicBackground />

      <div className="relative z-10 w-full max-w-md px-4">
        <div className="relative overflow-hidden rounded-2xl border border-white/10 p-6 sm:p-7 bg-black/40 backdrop-blur">
